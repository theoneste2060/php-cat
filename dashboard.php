...
<body>
    <div class="container">
        <section>
            <div class="row bg-primary text-white pb-1 pt-1"><center>IREMBO | Practical CAT</center></div>
            ...
            <div class="col-md-4 card pt-5" >
                ...
                <form method="post">
                    <div class="row">
                        <center>
                            <img src="Picture1.png" class="pb-5" alt="">
                        </center>
                    </div>
                    <div class="row">
                        <center>
                    ...
                    <div class="row col-sm-12" style="height:35vh;"></div>
                </form>
            </div>
            <div class="col-md-4"></div>
            </div>
